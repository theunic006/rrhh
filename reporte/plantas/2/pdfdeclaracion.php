...
<body>
    ...
    <div>
        ...
        <div class="delante estiloletra centro" id="anexo2">DECLARACION JURADA</div>

        <div class="delante" id="parrafo1">
            <p>
            <div class="tamano15">YO, <div class="estilogrueso"><?php echo $nombre?></div>, IDENTIFICADO CON DNI Y/O CARNE DE EXTRANGERIA Nº
                <div class="estilogrueso"><?php echo $dni?></div>, DOMICILIADO EN <div class="estilogrueso">
                    <?php echo $direccion?></div>, DEL DISTRITO DE <div class="estilogrueso"><?php echo $distrito?></div>
					PROVINCIA <div class="estilogrueso"><?php echo $provincia?></div>, DEPARTAMENTO DE <div
                    class="estilogrueso"><?php echo $departamento?></div>;
					DECLARO BAJO JURAMENTO HABER ENTENDIDO LA INDUCCION DE SEGURIDAD Y DOY FE QUE IDENTIFICO LOS PELIGROS, EVALUO Y CONTROLO LOS RIESGOS MAS CRITICOS QUE EXISTEN EN LA UNIDAD DE 
					PRODUCCION <div class="estilogrueso"><?php echo $unidadproduccion?></div>
            </div>
            </p>
			<div class="tamano15">DE, <div class="estilogrueso2"><?php echo $unidadproduccion?></div><div class="estilogrueso2"><?php echo $planta?></div>
            </div>
            </p>
			</p>
			<div class="tamano15">EN SEÑAL DE CONFORMIDAD FIRMO EL PRESENTE DOCUMENTO
            </div>
            </p>
			<p></p>
			<div class="tamano15">FIRMO EN LA CIUDAD DE  ANIMON - CHUNGAR SIENDO EL DIA <div class="estilogrueso2"><?php echo $dia?></div> día(s) de <div
                class="estilogrueso2"><?php echo $mes?></div> del <div class="estilogrueso2"><?php echo $año?></div>
            </div>
            </p>
