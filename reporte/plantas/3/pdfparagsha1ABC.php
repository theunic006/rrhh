...
<body>
	...
	<div>
		...
		<table  class="tabla3-1 estiloletra" border="1">
			<tbody>
				...
				<tr>
				<td style="padding-top:5px; padding-bottom:5px;">Desde: <b><?php echo $fechainicio?></b>   Hasta: <b><?php echo $fechafin?></b>  Duracion: <b><?php echo $dias?></b></td>
				</tr>
				<tr>
	...
	<div>
		...
		<div class="delante" id="parrafo1">
			<p class="p">Yo, <b>DANIEL JOSUE ALIAGA TAPIA</b>, identificado con DNI / Carnet de Extranjería N° <b>44068270</b>, con el cargo de Residente o máxima autoridad de la Empresa Especializada <b>Soluciones Industriales DEJOTA SAC</b>, en la Unidad de <b>PARAGSHA</b>, certifico bajo Declaración Jurada que toda la documentación adjunta al presente formato, siendo estos: Anexo A, Anexo B, Anexo C, Examen Médico Ocupacional, SCTR Salud y Pensión, copia DNI, Anexo 4, Anexo 5, Acta de asistencia Anexo 5 (Recorrido específico en campo y para cada trabajo) y Curriculum Vitae documentado; son veraces, originales, copia fiel del original legalizada o simple, pudiendo el Titular Minero verificar y auditar la información presentada, así como solicitar información complementaria si así lo considerase.</p>
		</div>

		<div class="delante" id="parrafo2">
			<p class="p">En caso se detectase que la información adjunta no sea veraz, sea falsificada, incompleta y/o adulterada, la Empresa Especializada <b>Soluciones Industriales DEJOTA SAC</b>, asumirá todas las responsabilidades y sanciones que se generen como consecuencia de la presentación de documentación falsa, adulterada o incompleta.</p>
	...
	<div>
		...
		<div class="delante" id="parrafo1">
			<p class="p">Yo, <b><?php echo $nombre?></b>, identificado con DNI / Carnet de Extranjería N° <b><?php echo $dni?></b>, domiciliado en <b><?php echo $direccion?></b>, Distrito de <b><?php echo $distrito?></b> Provincia de <b><?php echo $provincia?></b>, Departamento de <b><?php echo $departamento?></b>; declaro bajo juramento haber recibido y entendido la inducción del Anexo 4, además doy fe de que identifico los peligros, evaluó y controlo los riesgos realizando Trabajo Seguro que existen en el área de trabajo.</p>
		</div>
		...
		<p class="izquierda" style="margin-top:-2px; margin-bottom:0px;">Nombre: <b><?php echo $nombre?></b></p>
		<p class="izquierda" style="margin-top:-2px; margin-bottom:0px;">DNI:<b><?php echo $dni?><b> </p>
		</div>
	...
	<div>
		...
		<div class="delante" id="parrafo1-3">
			<p style="margin-top:-1px; margin-bottom:0px;">Apellidos y Nombres: <b><?php echo $nombre?></b></p>
			<p style="margin-top:-1px; margin-bottom:0px;">Domicilio: <b><?php echo $direccion?></b></p>
			<p style="margin-top:-1px; margin-bottom:0px;">Tipo de Documento de Identidad: DNI Nº:<b><?php echo $dni?></b></p>
			<p style="margin-top:-1px; margin-bottom:0px;">Edad: <b><?php echo $edad?></b> Sexo: <b><?php echo $genero?></b> Grupo Sanguíneo: <b><?php echo $gruposanguineo?></b></p>
			<p style="margin-top:-1px; margin-bottom:0px;">Institución de Procedencia (Razón Social): <b>Soluciones Industriales DEJOTA SAC</b></p>
		</div>
		...
		<div class="delante " id="subguion-3"><p class="izquierda">__________________________________ </p>
		<p class="izquierda" style="margin-top:-2px; margin-bottom:0px;">Nombre: <b><?php echo $nombre?></b></p>
		<p class="izquierda" style="margin-top:-2px; margin-bottom:0px;">DNI:<b> <?php echo $dni?><b> </p>
		</div>
	</div>
