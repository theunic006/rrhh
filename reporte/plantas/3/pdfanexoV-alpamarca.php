...
<body>
    <!--HOJA 02-->
    <div>
        <div class="delante estiloletra centro" id="anexo2">ANEXO V</div>
        ...
        <div class="delante" id="parrafo1">
            ...
            <div class="tamano17">Yo, <div class="estilogrueso">DANIEL JOSUE ALIAGA TAPIA</div>, identificado con DNI /
                ...
                autoridad de la Empresa Especializada <div class="estilogrueso">S. I. DEJOTA SAC
                </div>, en la Unidad de <div class="estilogrueso"><?php echo $unidadproduccion?> </div> (el adelante La Unidad), certifico bajo Declaración Jurada que
                toda la documentación adjunta al presente formato, siendo estos: Anexo V, Anexo B, Anexo C, copia legalizada de contrato visado por Migraciones (aplicable a extranjeros), Examen
                ...
                originales, copia fiel del original legalizada o simple, pudiendo Volvan Compañia Minera S.A.A., verificar y auditar la informacion
				presentada, asi como solicitar informacion complementaria si asi lo considerase.</div>
            </p>
        </div>
        ...
        <div class="delante" id="parrafo2">
            ...
            <p>
            <div class="tamano17">En caso se detecte que la informacion adjunta sea falsificada, incompleta y/o adulterada, la Empresa Especializada 
				asumirá todas las responsabilidades y sanciones que se generen como consecuencia de la presentacion de documentacion
				falsa, adulterada o incompleta.</div>
            </p>
            <p>
			...
			<p class="estilogrueso5 centro">DANIEL JOSUE ALIAGA TAPIA</p>
        </div>
